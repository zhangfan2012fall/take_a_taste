...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "fz2160-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/take_a_taste"
  #   chef.validation_client_name = "take_a_taste-validator"
  #   chef.validation_key_path = ".chef/take_a_taste-validator.pem"
  # end
end
